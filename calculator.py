...
Button(root,text=" 1",command=lambda :get(1)).grid(row=4,column=0)
Button(root,text=" 2",command=lambda :get(2)).grid(row=4,column=1)
Button(root,text=" 3",command=lambda :get(3)).grid(row=4,column=2)
Button(root,text=" 4",command=lambda :get(4)).grid(row=3,column=0)
Button(root,text=" 5",command=lambda :get(5)).grid(row=3,column=1)
Button(root,text=" 6",command=lambda :get(6)).grid(row=3,column=2)
Button(root,text=" 7",command=lambda :get(7)).grid(row=2,column=0)
Button(root,text=" 8",command=lambda :get(8)).grid(row=2,column=1)
Button(root,text=" 9",command=lambda :get(9)).grid(row=2,column=2)
Button(root,text=" 0",command=lambda :get(0)).grid(row=5,column=1)
...
Button(root,text="  x !",command=lambda :fact(display.get())).grid(row=5,column=5)
